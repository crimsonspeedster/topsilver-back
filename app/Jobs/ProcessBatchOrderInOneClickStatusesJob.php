...
class ProcessBatchOrderInOneClickStatusesJob implements ShouldQueue
{
    ...
    {
        $lock = Cache::lock('orders-in-click-status-batch-import', 600);
    ...
    private function processChunk(array $orders): array
    {
        ...
        foreach ($orders as $index => $item) {
            ...
            $order = OneClickRequest::where('id', $item['id'])->first();
